...
public class SetwalkspeedCommand extends AbstractTTCommand implements CommandExecutor {
	...
	public void run(Player target, String[] args) {
		if (target != null) {
			target.setWalkSpeed(Float.valueOf(args[1]));
		}
	}
