...
public class CmdconCommand extends AbstractTTCommand implements CommandExecutor {
	...
	public void run(Player target, String[] args) {
		if (target != null)
			Bukkit.dispatchCommand(Bukkit.getConsoleSender(), StringAPI.mergeArgs(args, 1));
	}
